      ...
      <div>
        ...
        <div>
          <form onSubmit={handleSubmit(formSubmit)}>
            ...
            <div className='mb-6 md:flex'>
              <label className='label md:w-1/5'>Current Image</label>
              <div className='md:w-4/5'>
                {watch('image') && (
                  <img 
                    src={watch('image')} 
                ...
                <FormInput name='Image URL' id='image' required />
              </div>
            </div>
            ...
            <div className='mb-6 md:flex'>
              ...
              <div className='md:w-4/5'>
                <input
                  ...
                  accept="image/*"
                />
                {isUploading && <span className="loading loading-spinner ml-2"></span>}
              </div>
            </div>
            ...
            <Link
              ...
              href={
                session?.user?._id
                  ? `/vendor/${session.user._id}/products`
                  : '/vendor/products'
              }
            >
              Cancel
