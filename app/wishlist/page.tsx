      ...
      <div className="px-4 py-6 max-w-6xl mx-auto w-full">
        ...
        {wishlistItems.length > 0 ? (
              ...
              >
                ...
                <div className="p-3">
                  ...
                  <div className="flex justify-between items-center mt-4">
                    <button
                      onClick={() => removeItem(product._id)}
                      className="flex items-center gap-2 text-[#bf2c7e] hover:text-red-600 transition-transform transform hover:scale-110"
                    >
                      <FaHeart size={16} />
                    ...
                    <button
                      onClick={() => handleProductClick(product._id)}
                      className="flex items-center gap-2 bg-[#0f1c47] text-white px-3 py-1.5 rounded-md text-sm hover:bg-blue-700 transition"
                    >
                      <ViewIcon size={20} />
                      View
                    </button>
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            <img src="/empty-wishlist.png" alt="Empty Wishlist" className="w-40 mb-4" />
            <p className="text-gray-500 text-lg">Your wishlist is empty.</p>
            <button
              onClick={() => router.push("/shop")}
              className="mt-4 bg-blue-600 text-white px-5 py-2 rounded-md text-sm hover:bg-blue-700 transition"
            >
              Explore Products
            </button>
          </div>
