                ...
                <div className="space-y-4">
                  {items.map((item) => (
                    <motion.div
                      ...
                      className="flex flex-col sm:flex-row gap-6 border-b border-gray-200 pb-4"
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="mt-4 flex items-center justify-between">
                          ...
                          <p className="text-md font-bold text-[#bf2c7e]">
          ...
          <div className="flex items-center justify-start gap-3">
            <Link href="/collections" passHref legacyBehavior>
              <motion.a
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="inline-block p-2 bg-[#bf2c7e] hover:bg-[#9f2565] text-white rounded-full transition-colors"
              >
                <ArrowLeft size={24} />
              </motion.a>
            </Link>
