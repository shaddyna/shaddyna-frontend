...
/*export const useUserSellerStore = create<UserSellerStore>((set) => ({
  ...
  fetchUsers: async () => {
    try {
      const response = await axios.get('https://shaddyna-backend.onrender.com/api/users'); // Adjust the API endpoint
  ...
  fetchSellers: async () => {
    try {
      const response = await axios.get('https://shaddyna-backend.onrender.com/api/sellers'); // Adjust the API endpoint
