...
import HeroCarousel from './Courosel';
...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section className="hidden sm:grid md:grid-cols-1 lg:grid-cols-5 gap-4 lg:px-8 xl:px-16 relative w-full h-[400px] sm:h-[600px] lg:h-[700px] mt-4 lg:mt-0">
      {/* Large image for larger screens */}
      <div
        className="col-span-3 lg:col-span-3 relative bg-cover bg-center bg-no-repeat bg-contain rounded-2xl overflow-hidden"
        style={{ backgroundImage: `url(${imageUrl})`, backgroundSize: 'cover' }}
