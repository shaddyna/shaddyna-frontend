...
import { ChevronDown, ChevronUp, Check, Star, Award, Briefcase, Clock, Sparkles } from "lucide-react";
...
interface ServiceCardProps {
  ...
  setActiveService: React.Dispatch<React.SetStateAction<number | null>>;
  handleContinueClick: (service: Service) => void;
}

const ServiceCard: React.FC<ServiceCardProps> = ({ service, activeService, setActiveService, handleContinueClick }) => {
  const toggleService = () => {
          ...
          <div className="flex-shrink-0">
            <div className="relative">
              <img
                ...
                className="w-20 h-20 rounded-full object-cover border-2 border-[#f4b500]"
              />
              {service.isProVerified && (
                <div className="absolute -bottom-1 -right-1 bg-[#f4b500] text-white p-1 rounded-full">
            ...
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
              <div>
                ...
                <div className="flex items-center gap-2 mb-4">
                  <div className="flex items-center gap-1 bg-[#f4b500]/10 px-2 py-1 rounded-full">
                    <Star className="text-[#f4b500] fill-[#f4b500]" size={16} />
              ...
              <div className="flex-shrink-0 bg-gray-50 p-3 rounded-lg">
                <p className="font-bold text-[#f4b500] text-lg">{service.price}</p>
              </div>
            </div>
        ...
        >
          <div className="pt-4 border-t border-gray-100">
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start gap-2">
                    <Check className="h-5 w-5 text-[#f4b500] flex-shrink-0" />
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full mt-6 bg-[#f4b500] hover:bg-[#d4a017] text-black font-bold py-3 rounded-lg"
